...
@NgModule({
	declarations: [AppComponent, AboutPageComponent, TeamComponent, BannerComponent, AboutComponent],
	imports: [BrowserModule.withServerTransition({ appId: 'serverApp' }), SharedModule],
	providers: [],
